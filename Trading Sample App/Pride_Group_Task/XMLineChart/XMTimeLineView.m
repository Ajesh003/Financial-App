...
- (void)drawTimeLabel:(CGContextRef)context
{
    ...
    NSMutableAttributedString * startTimeAttStr = [[NSMutableAttributedString alloc]initWithString:self.dataset.firsttime attributes:drawAttributes];
    ...
    NSMutableAttributedString * midTimeAttStr = [[NSMutableAttributedString alloc]initWithString:self.dataset.midtime attributes:drawAttributes];
    ...
    NSMutableAttributedString * stopTimeAttStr = [[NSMutableAttributedString alloc]initWithString:self.dataset.lasttime attributes:drawAttributes];
